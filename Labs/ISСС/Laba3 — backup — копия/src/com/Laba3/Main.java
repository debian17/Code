...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(terminator.Property+" Cost="+terminator.GetCost());
    }
}
