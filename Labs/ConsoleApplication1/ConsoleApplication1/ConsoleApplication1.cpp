...
{
	// Загрузка картинки
	AUX_RGBImageRec *texture1 = auxDIBImageLoadA("kk.bmp"),
		*texture2 = auxDIBImageLoadA("kk.bmp"),
		*texture3 = auxDIBImageLoadA("kk.bmp"),
		*texture4 = auxDIBImageLoadA("kk.bmp"),
		*texture5 = auxDIBImageLoadA("kk.bmp"),
		*texture6 = auxDIBImageLoadA("kk.bmp");
	// Создание текстуры
