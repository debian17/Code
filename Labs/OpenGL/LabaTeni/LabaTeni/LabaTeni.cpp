...
GLuint	texture[6];
/*
static BITMAP LoadPicture(string filename)
{
...
GLvoid LoadGLTextures()
{
	...
	AUX_RGBImageRec *texture1 = auxDIBImageLoadA("pl.bmp"),
		*texture2 = auxDIBImageLoadA("eye.bmp"),
...
void Jet(int nShadow, GLenum order)
{
	...
	glVertex3f(-100.0f, -150.0f, -300.0f);//(-400.0f, -150.0f, -300.0f);
	glColor3d(222, 184, 135);
	glTexCoord2f(1.0f, 0.0f);
	glVertex3f(-250.0f, -150.0f, 300.0f);//(-400.0f, -150.0f, 300.0f);
