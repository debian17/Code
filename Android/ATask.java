 ...
 *
 * Более быстрая работа, поддержка нескольких видов исполнения и отлова исключений.
 *
...
public abstract class ATask<Params, Progress, Result> {
     ...
     * @throws Throwable при любой исключительной ситуации. Обработать его вы сможете в {@link #onError(Throwable)}.
     */
